const CardTextR = ({
  ...
  return (
    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 bg-slate-50 rounded-lg">
      ...
      <div className="overflow-hidden bg-cover cursor-pointer h-96 group bg-slate-100  border border-slate-100 bg-center rounded-lg"
      ...
      {/* PROJECT INFO */}
      <div className="flex flex-col justify-between mr-4 ml-6 md:ml-2 my-8">
        <div>
