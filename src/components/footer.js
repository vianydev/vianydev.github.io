    ...
    <footer className="w-full bg-slate-100" aria-labelledby="footer-heading">
      ...
      <div className="w-full px-5 py-12 mx-auto max-w-7xl sm:px-6 md:flex md:items-center md:justify-between lg:px-20">
        <div className="flex justify-center mb-8 space-x-6 md:order-last md:mb-0">
          ...
          <a href="https://www.instagram.com/digitalgrowersmx/" className="text-gray-400 hover:text-indigo-600">
          ...
          <a href="https://github.com/vianydev" className="text-gray-400 hover:text-indigo-600">
          ...
          <a href="#" className="text-gray-400 hover:text-indigo-600">
            ...
            <svg fill="currentColor" className="w-6 h-6 text-xl transition-colors duration-200" viewBox="0 0 1792 1792">
