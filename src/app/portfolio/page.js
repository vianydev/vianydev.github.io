  ...
  return (
    <section className="bg-white mx-auto px-3 max-w-7xl md:px-20 lg:px-24 py-36">
      ...
      <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 bg-slate-50 rounded-lg">
        ...
        <div className="flex flex-col justify-center content-start mx-2 mb-8"> 
          <h2 className="mt-8 mb-4 text-xs font-semibold tracking-widest text-blue-600 uppercase">Project type</h2>
          <h1 className="mb-8 text-2xl font-semibold leading-none tracking-tighter text-neutral-600 lg:text-3xl">Project name</h1>
